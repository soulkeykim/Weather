...
public class WTTestRunner extends RobolectricGradleTestRunner {
    ...
    public WTTestRunner(Class<?> klass) throws InitializationError {
        super(klass);
    }
        ...
        if (config == null) {
            ...
            return new DelegatingConfig(config) {
                ...
                public String packageName() {
                    ...
                    return WTTestRunner.class.getPackage().getName();
                }
