...
public class WTLifecycleCallbacksTests {

    @Test
    public void testIsAppInForegroundWithSingleResumedActivity() {
        final WTLifecycleCallbacks callbacks = createCallbacks();
    ...
    private WTLifecycleCallbacks createCallbacks() {
        return new WTLifecycleCallbacks(){};
    }
